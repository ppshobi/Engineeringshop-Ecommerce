...
<head>
    ...
    <title>Categories Grid2 Right Sidebar</title>
...
<body class="categories-page">
                    ...
                    <ul id="primary-menu" class="menu">
                        ...
                        <li class="menu-item has-childrent active">
                            ...
                            <ul class="sub-menu">
                                ...
                                <li class="menu-item active"><a href="categories-grid2-right-sidebar.html">Categories Grid 2 Right Sidebar</a></li>
    ...
    <div class="main-content categories categories-grid2" style="background-color: #F5F5F5">
        <div class="container">
            ...
            <div class="row">
                <div class="content col-md-9 has-sidebar-right">
