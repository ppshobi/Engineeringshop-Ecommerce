...
<head>
    ...
    <title>Categories Grid Right Sidebar</title>
                    ...
                    <ul id="primary-menu" class="menu">
                        ...
                        <li class="menu-item has-childrent active">
                            ...
                            <ul class="sub-menu">
                                ...
                                <li class="menu-item active"><a href="category-grid-right-sidebar.html">Categories Grid 1 Right Sidebar</a></li>
    ...
    <div class="main-content categories categories-grid1" style="background-color: #F5F5F5" data-background-color="#F5F5F5">
        <div class="container">
            <div class="categories-page">
                <div class="row">
                    <div class="categories-grid content col-md-9 has-sidebar-right">
