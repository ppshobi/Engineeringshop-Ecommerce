...
<head>
    ...
    <title>Categories list2 Right Sidebar</title>
...
<body class="categories-page">
                    ...
                    <ul id="primary-menu" class="menu">
                        ...
                        <li class="menu-item has-childrent active">
                            ...
                            <ul class="sub-menu">
                                ...
                                <li class="menu-item active"><a href="categories-list2-right-sidebar.html">Categories List 2 Right Sidebar</a></li>
                            </ul>
                        </li>
    ...
    <!-- End .banner -->
    <div class="categories categories-list2">
        <div class="container">
            <div class="banner-categories-grid">
                <img src="assets/images/grid2.jpg" alt="banner" height="175" width="868">
            </div>
            <div class="row">
                <div class="content content-categorise col-md-9 has-sidebar-right">
                    <div class="categories-list">
                        ...
                        <div class="products-categories">
                            <div class="product-box">
                                <div class="product-box-content">
                                    <figure class="img-product">
                                        <img src="assets/images/c-p1.jpg" alt="product" height="309" width="268">
                            ...
                            <div class="product-box">
                                <div class="product-box-content">
                                    <figure class="img-product">
                                        <img src="assets/images/c-p2.jpg" alt="product" height="309" width="268">
                                        <a href="#" class="flaticon-search"></a>
                                    </figure>
                                    <div class="product-box-text">
                                        <a href="#" class="product-name">Men's Skagen Watch</a>
                            ...
                            <div class="product-box">
                                <div class="product-box-content">
                                    <figure class="img-product">
                                        <img src="assets/images/c-p3.jpg" alt="product" height="309" width="268">
                                        <a href="#" class="flaticon-search"></a>
                                    </figure>
                                    <div class="product-box-text">
                                        <a href="#" class="product-name">Men's Skagen Watch</a>
                            ...
                            <div class="product-box">
                                <div class="product-box-content">
                                    <figure class="img-product">
                                        <img src="assets/images/c-p4.jpg" alt="product" height="309" width="268">
                                        <a href="#" class="flaticon-search"></a>
                                    </figure>
                                    <div class="product-box-text">
                                        <a href="#" class="product-name">Men's Skagen Watch</a>
                            ...
                            <div class="product-box">
                                <div class="product-box-content">
                                    <figure class="img-product">
                                        <img src="assets/images/c-p5.jpg" alt="product" height="309" width="268">
                                        <a href="#" class="flaticon-search"></a>
                                    </figure>
                                    <div class="product-box-text">
                                        <a href="#" class="product-name">Men's Skagen Watch</a>
                            ...
                            <div class="product-box">
                                <div class="product-box-content">
                                    <figure class="img-product">
                                        <img src="assets/images/c-p6.jpg" alt="product" height="309" width="268">
                                        <a href="#" class="flaticon-search"></a>
                                    </figure>
                                    <div class="product-box-text">
                                        <a href="#" class="product-name">Men's Skagen Watch</a>
