                ...
                <nav id="primary-navigation" class="site-navigation main-menu menu-home1">
                    <ul id="primary-menu" class="menu">
                        ...
                        <li class="menu-item has-childrent active">
                            <a href="#">Pages</a>
                            <ul class="sub-menu">
                                <li class="menu-item active"><a href="blogpost.html">Blog Post</a></li>
            ...
            <div class="row">
                <div class="content blog-content col-md-9 has-sidebar-left">
                    ...
                    <ul class="blog-post-meta">
                        ...
                        <li>Created Date: Mon, Mar 30, 2016</li>
                        <li><a href="#">10 Coment(s)</a></li>
                    </ul>
                    <div class="blog-box">
                        <figure><img src="assets/images/blog-post.jpg" alt="blog-post" height="334" width="569"></figure>
                    ...
                    <div class="comment-blog">
                        ...
                        <p class="show-page"><a href="#">Showing 1 to 4 of 4 (1 Pages)</a></p>
                    </div>
                    <div class="comment-blog-form">
                        <p class="title-left">Leave your comment </p>
                        <div class="row">
                            <div class="col-md-7">
                        ...
                        <p class="submit-comment"><a class="button orange" href="#">Submit</a></p>
                    </div>
                </div>
