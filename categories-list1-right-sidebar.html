...
<head>
    ...
    <title>Categories list1 Right Sidebar</title>
                ...
                <ul id="primary-menu" class="menu">
                    ...
                    <li class="menu-item has-childrent active">
                        ...
                        <ul class="sub-menu">
                            ...
                            <li class="menu-item active"><a href="categories-list1-right-sidebar.html">Categories List 1 Right Sidebar</a></li>
        ...
        <div class="row">
            <div class="content content-categorise col-md-9 has-sidebar-right">
                <div class="banner-categories-grid">
                    <img src="assets/images/list-banner2.jpg" alt="banner" height="175" width="1170">
                </div>
